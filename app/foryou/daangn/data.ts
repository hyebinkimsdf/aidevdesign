...
export const about = {
  ...
  role: "풀스택 웹 개발자",
  photo: "/profile.jpg",
  intro: "게임영상 전공으로 시작해서 디자인을 배우고, 어느 순간 개발까지 하고 있었어요. '이걸 왜 두 명이 해야 하지?'라는 생각에 혼자 다 해보기 시작했고, 지금은 상담부터 배포까지 전부 혼자 해낼 수 있게 됐습니다.",
  ...
  careers: [
    ...
    },
    {
      ...
      tasks: [
        ...
        "아이 러브 버거, 마스터 오브 나이츠 등 모바일 게임 프로젝트 참여",
        "운영 업무 및 그래픽 디자인 병행",
      ],
    },
  ],
